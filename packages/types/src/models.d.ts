import { PolicyStatus, PolicyTheme, SourceType, ContributionType, ContributionStatus, UserRole, UserLevel, WorkflowStatus, VoteTargetType, NotificationChannel, SenegalRegion } from './enums';
...
export interface GlobalStats {
    ...
    totalUsers: number;
    byTheme: Record<PolicyTheme, {
        total: number;
        completed: number;
        rate: number;
    }>;
    byRegion: Record<SenegalRegion, {
        total: number;
        completed: number;
    }>;
}
